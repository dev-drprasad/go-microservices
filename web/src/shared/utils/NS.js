export default class NS {
   ...
   */
  constructor(
      status, message, statusCode = 0, responseTime = 0, requestId,
      cached = false, hasData = false, errorCaught = false) {
    this.code = status;
  ...
  clone(
      status, message, statusCode, responseTime, requestId, cached, hasData,
      errorCaught) {
    return new NS(
